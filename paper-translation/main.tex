...
%
% Copyright 2020-2021  Feng Kaiyu
%
...
% 在这里填写你的论文中英文题目
\newcommand{\thesisTitle}{北京理工大学本科生毕业设计（论文）外文翻译题目}
\newcommand{\thesisTitleEN}{The Subject of Paper Translation of Undergraduate Graduation Project (Thesis) of Beijing Institute of Technology}

% 在这里填写你的相关信息
\newcommand{\deptName}{请按照学院要求}
\newcommand{\majorName}{在打印后替换该封面}
